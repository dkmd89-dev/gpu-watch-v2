...
- **Problem**: 1 bestaetigte(r) Fehltreffer, root_cause=`missing_exclude` (confidence=confirmed), 0 davon weiterhin aktiv.
...
- **Problem**: 3 bestaetigte(r) Fehltreffer, root_cause=`missing_exclude` (confidence=confirmed), 0 davon weiterhin aktiv.
- **Vorschlag**: `add_exclude`
- **Regression-Risiko**: LOW
- **Betroffene Kategorien**: handhelds
- **Regressionstests**:
...
- **Problem**: 2 bestaetigte(r) Fehltreffer, root_cause=`replacement_part_false_positive` (confidence=confirmed), 0 davon weiterhin aktiv.
- **Vorschlag**: `add_replacement_part_guard`
- **Regression-Risiko**: LOW
...
- **Problem**: 3 bestaetigte(r) Fehltreffer, root_cause=`weak_signal` (confidence=confirmed), 0 davon weiterhin aktiv.
- **Vorschlag**: `strengthen_positive_signal`
- **Regression-Risiko**: HIGH
- **Betroffene Kategorien**: konsolen_bundles
- **Regressionstests**:
